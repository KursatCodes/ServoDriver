...
unsigned int displayValue = 0;
...

  {
        ...
        GO = 1;
        while (GO) ;
        unsigned int adcValue1 = ADRESH;


        ADCON0 = 0b10001101;
        GO = 1;
        while (GO) ;
        unsigned int adcValue2 = ADRESH;
        float floatVal = adcValue2 / 255.0;


        Lcd_Set_Cursor(2, 1);
        Lcd_Write_String("rate: ");
        char adcString1[4];
        sprintf(adcString1, "%3u", adcValue1);
        Lcd_Set_Cursor(2, 7);
        Lcd_Write_String(adcString1);


        Lcd_Set_Cursor(2, 13);
        Lcd_Write_String("float: ");
        char adcString2[4];
        sprintf(adcString2, "%3.1f", floatVal);
        Lcd_Set_Cursor(2, 20);
        Lcd_Write_String(adcString2);
       ...
       if (RC1 == 1 && RE1==1)
        ...
        {
            Lcd_Set_Cursor(1, 12);
            Lcd_Write_String("FEAD 400");
            UART_Write_Text("s-255\r\n");
        }
    ...
    UART_Write_Text(combinedText);
        ...
        else
        {
            ...
            if(RC2==0 && RC1==0 && RE2==0 && RC0==0 && RC3==0){
...
if (RC3==1){
    RA4=1;
    Lcd_Set_Cursor(1,7);
            Lcd_Write_String("DC SERVO ERROR");
