...
static void dtoa(FILE *fp, vfpf_sint_t d)
{
 ...
 _Bool p = 1;
    ...
    s = d < 0 ? 1 : 0;
# 535 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\sources\\c99\\common\\doprnt.c"
    w = width;
    if (s
...
static void utoa(FILE *fp, vfpf_uint_t d)
{
 ...
 _Bool p = 1;
# 1019 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\sources\\c99\\common\\doprnt.c"
    w = width;
        ...
        while (!done) {
            switch ((*fmt)[0]) {
                ...
                case '0' :
                    ...
                    ++*fmt;
                    break;
# 1242 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\sources\\c99\\common\\doprnt.c"
                default:
                    done = 1;
                    break;
            }
